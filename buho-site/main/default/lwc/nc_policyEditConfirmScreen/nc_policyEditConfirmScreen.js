...
export default class Nc_policyEditConfirmScreen extends NavigationMixin(LightningElement) {
    ...
    goToDetailPage() {
        ...
        if (this.isBuhoUI) {
            // Store policyId so buhodb_mypolicy can restore the detail view
            localStorage.setItem('buhoPolicyDetailId', recordId);
            // Navigate back to policy detail inside the dashboard container
            this.dispatchEvent(
