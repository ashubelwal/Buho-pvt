...
import defaultTemplate from './partnerProfile.html';
import newUiTemplate from './partnerProfileNewUI.html';
...
export default class PartnerProfile extends LightningElement {
    ...
    fields = [FIRSTNAME, LASTNAME, EMAIL, CompanyName, LOCALSIDKEY, LanguageLocaleKey, MOBILE, USERNAME];
