...
export default class CustomLookup extends LightningElement {
    ...
    startLookingUp(event) {
        ...
        console.log('searchInput.value.trim().length = ', this.searchagainst);
        console.log('searchInput.value.trim().length = ', this.secondaryfield);
        console.log('searchInput.value.trim().length = ', this.postalCodeId);
