...
import logClientError from '@salesforce/apex/CustomErrorExceptionHandlerException.logClientError';
...
export default class Payment extends NavigationMixin(LightningElement) {
    ...
    getPopulateDetailsCard() {
        ...
        if (ownerDriver.Driver_Type__c != undefined && ownerDriver.Driver_Type__c != null && (ownerDriver.Driver_Type__c == 'Owner' || ownerDriver.Driver_Type__c == "Owner & Driver")) {
            this.paymentDetails = {
    ...
    handlePayment = async () => {
        ...
        if (allValid || this.selectedCardId != '') {
           ...
           this.logLwcError('handlePaymenterror','Payment','Lineno676', error.message,this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'handlePayment');
    ...
    getPaymentInfo = async () => {
        ...
        this.logLwcError('getPaymentInfoErrror','Payment','Lineno904',JSON.stringify(error),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'getPaymentInfo');    
        }
    }
    ...
    createPaymentProfileAction = async () => {
        ...
        try {
            ...
            this.generateLogs();
            this.logLwcError('createPaymentProfileActionError','Payment','Lineno757',JSON.stringify(error),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createPaymentProfileAction');
            console.log('test');
    ...
    createPaymentProfileTransactionAction = async (paymentProfileId) => {
        ...
        try {
            ...
            if (createProfileTrans.status == 'success') {
                ...
                this.logLwcError('CreateTransactionActionSuccess','Lineno 911 Payment',JSON.stringify(transactionDetails),JSON.stringify(createProfileTrans),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createPaymentProfileTransactionAction');

            } else {
                this.spinner = false;
                this.generateLogs();
                this.logLwcError('CreateTransactionActionError','Payment','Lineno916',JSON.stringify(createProfileTrans),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createPaymentProfileTransactionAction');
            ...
            this.generateLogs();
            this.logLwcError('CreateTransactionActionError','Payment','Lineno916',JSON.stringify(err),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createPaymentProfileTransactionAction');
            console.log('--error--new implemented', err);
            this.spinner = false;
            const evt = new ShowToastEvent({
                title: 'Error',
    ...
    createTransaction = async () => {
        ...
        try {
            ...
            if (createTransactionData.status == 'success') {
                this.logLwcError('Payment success','Payment','Lineno954',JSON.stringify(createTransactionData),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createTransaction');
                const evt = new ShowToastEvent({
                    title: this.label.Success,
                    message: this.label.Paymentsuccessfull,
                    variant: 'success',
                ...
                this.generateLogs();
                this.logLwcError('Payment error','Payment','Lineno1001',JSON.stringify(createTransactionData),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createTransaction');
            ...
            this.generateLogs();
            this.logLwcError('Payment error','Payment','Lineno1014',JSON.stringify(error),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createTransaction');
    ...
    createPolicy = async () => {
        ...
        if (this.communityUser != null && this.customerRecord != null && this.communityUser) {
            if (this.policyType == 'Watercraft') {
                ...
                this.logLwcError('Create policy method','Payment','Lineno1305',JSON.stringify(policy),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createPolicyForExistingCustomer');
        ...
        if (resParse.status == 'success') {
            ...
            this.generateLogs();
            this.logLwcError('Create policy method','CreatePolicy','Lineno1340',JSON.stringify(resParse),this.customerRecord !=null ? JSON.stringify(this.customerRecord) : JSON.stringify(this.leaddata),'createPolicyForExistingCustomer');
    ...
    logLwcError(error, componentName,stackTrace,relatedToId, extraData,methodName) {
