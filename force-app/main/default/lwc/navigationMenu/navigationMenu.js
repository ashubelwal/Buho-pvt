...
export default class NavigationMenu extends NavigationMixin(LightningElement) {
    ...
    customMetaData({data,error}){
        if(data){
            ...
            if(data?.Partner_Name__c != null && data?.Partner_Name__c != undefined ){
                this.partnerName = data.Partner_Name__c;
            }

            if(data?.Partner_Id__c != null && data?.Partner_Id__c != undefined ){
                this.partnerId = data.Partner_Id__c;
            }

            if(data?.Partner_email__c != null && data?.Partner_email__c != undefined ){
                this.partnerEmail = data.Partner_email__c;
            }

            if(data?.Logo_URL__c != null && data?.Logo_URL__c != undefined ){
    ...
    handleMenuSelect(event) {
        ...
        if(selectedItemValue == 'logout'){
            console.log('logout');
            location.replace('https://at.mexinsurance.com/agency/secur/logout.jsp');
           //this.dispatchEvent( new CustomEvent('logout'));
            ...
            location.replace('https://at.mexinsurance.com/agency/profile')            
        }else{
