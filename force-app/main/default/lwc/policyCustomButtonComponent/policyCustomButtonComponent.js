...
export default class PolicyCustomButtonComponent extends NavigationMixin(LightningElement) {
 label = {
    ...
    generatePolicyGreenCard(event){
        ...
        console.log('generate policy green card ');
