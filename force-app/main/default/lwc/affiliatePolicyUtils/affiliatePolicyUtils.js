...
export default class AffiliatePolicyUtils extends LightningElement {
    ...
    handleInputChange = (event) => { 
        ...
        if (event.target?.name == 'Policy_Type__c') {
            ...
            if (event.target.value == 'Automobile') {
            ...
            if (event.target?.value == 'Automobile' || event.target?.value == 'RV') {
    ...
    async saveLeadDetailsintoApex(leadJSON, quoteJSON, vechileJSON, towedJSON) {
        ...
        try {
            ...
            console.log('Error in saving quote 1--->', error);
            this.booleanVar.isLoading = false;
            throw error;
        }
    }
