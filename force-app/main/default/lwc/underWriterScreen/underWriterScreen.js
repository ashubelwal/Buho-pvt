...
export default class UnderWriterScreen extends NavigationMixin(LightningElement) {
    label = {
    ...
    async fetchQuoteData(quoteDetails) {
        ...
        if (isValid) {
            ...
            if(qt.Policy_Type_picklist == 'Motorcycle/Street Legal ATV' && this.mapfreLiability == '1000000'){
            ...
            console.log('teshitng -> '+JSON.stringify(this.quickQuoteDetail));
                ...
                if (updateCloneQuote.status == 'success') {
                    let cstEvent = new CustomEvent('navigatepaymentscreen',{
                        detail:{
                            ...
                            'rateValue':selectQuote.rateValue
                        }
                    });
                    this.dispatchEvent(cstEvent);
                }
            }else{
                console.log('error'+JSON.stringify(createCloneQuoteReacord));
            }
