...
export default class NorthboundQuoteScreen extends NavigationMixin(LightningElement) {
     label = {
    ...
    fetchQuoteData = async (quoteDetails) => {
        ...
        if (isValid) {
            let vehicleAge = new Date().getFullYear() - parseInt(quoteDetails.Vehicle_Year__c?quoteDetails.Vehicle_Year__c:quoteDetails.Year__c);
                ...
                if (this.isRenewalPolicy == 'Yes') {
                    ...
                    let cstEvent = new CustomEvent('navigatepaymentscreen',{
                        detail:{
                            ...
                            'rateValue':this.quickQuoteDetail.rateValue
                        }
                    });
